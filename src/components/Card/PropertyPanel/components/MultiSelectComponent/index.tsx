...
import { multiSelectComponentStateManager } from '../../../Variable/utils/index';
              ...
              <div style={{ padding: '16px' }}>
                ...
                >
                  ...
                  <Form form={form} layout="vertical">
                    ...
                    <Form.Item label="最大选择数量">
                      <InputNumber
                        value={(selectedComponent as any).maxCount}
                        onChange={(value) =>
                          handleValueChange('maxCount', value)
                        }
                        min={1}
                        max={10}
                        style={{ width: '100%' }}
