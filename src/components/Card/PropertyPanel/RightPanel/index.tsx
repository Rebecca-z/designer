...
export const PropertyPanel: React.FC<PropertyPanelProps> = ({
  ...
  // 如果选中的是卡片根节点或下拉单选组件，使用PropertyPanel结构
  if (isCardRoot || componentTypeChecks.isSelectComponent) {
    return (
          ...
          items={[
            {
              ...
              children: (
                <div style={{ padding: '16px' }}>
                  ...
                  ) : componentTypeChecks.isSelectComponent ? (
                    // 下拉单选组件属性
                    <div>
                      <div
                        style={{
                          ...
                          >
                            ...
                            <Form layout="vertical">
                              <Form.Item label="必填">
                                <Switch
                                  checked={
                                    (selectedComponent as any)?.required ||
                                    false
                                  }
                                  onChange={(checked) =>
                      ...
                      >
                        ...
                        <Form layout="vertical">
                          <Form.Item label="选项来源">
                            <Segmented
                              value={contentModes.selectOptions}
                            ...
                            {contentModes.selectOptions === 'specify' && (
                              <div style={{ marginBottom: 16 }}>
                                ...
                                {Array.isArray(
                                  ...
                                  (
                                    (selectedComponent as any).options as any[]
                            ...
                            {contentModes.selectOptions === 'variable' && (
                              <div>
                                    ...
                                    {variables
                                      .filter((variable: any) => {
                                        if (
                                          ...
                                          const varType = (variable as any)
                                            .type;
                                          return varType === 'array';
                                        }
                                        const varType =
                                          (variable as any).originalType ||
                ...
                <div style={{ padding: '16px' }}>
                  ...
                  >
                    ...
                    <Form layout="vertical">
                      <Form.Item label="URL">
                        <Input
                          value={cardData?.dsl?.card_link?.multi_url?.url || ''}
                          onChange={(e) =>
                            handleValueChange('card_link.multi_url', {
                      ...
                      <Form.Item label="Android URL">
                        <Input
                          value={
                            cardData?.dsl?.card_link?.multi_url?.android_url ||
                            ''
                          }
                          onChange={(e) =>
                            handleValueChange('card_link.multi_url', {
                      ...
                      <Form.Item label="iOS URL">
                        <Input
                          value={
                            cardData?.dsl?.card_link?.multi_url?.ios_url || ''
                          }
                          onChange={(e) =>
                            handleValueChange('card_link.multi_url', {
                              ...cardData?.dsl?.card_link?.multi_url,
                      ...
                      <Form.Item label="PC URL">
                        <Input
                          value={
                            cardData?.dsl?.card_link?.multi_url?.pc_url || ''
                          }
                          onChange={(e) =>
                            handleValueChange('card_link.multi_url', {
                              ...cardData?.dsl?.card_link?.multi_url,
                              pc_url: e.target.value,
                            })
                          }
