...
const TestOriginalValidation: React.FC = () => {
  ...
  const testOriginalValidation = async () => {
    addLog('=== 测试原始JSON验证 ===');
  ...
  return (
    <div style={{ padding: '20px' }}>
      ...
      <div style={{ marginBottom: '20px' }}>
        <Button onClick={testOriginalValidation} type="primary">
          测试原始验证流程
        </Button>
        <Button
...
export default TestOriginalValidation;
